...
<div id="form-box">
    <form action="register_examination" method="POST">
        <div id="inner-box">
            ...
            <div class="input-field" id="disease-box">
                <label>Disease:</label>
                <textarea name="disease" id="disease-field"></textarea>
            </div>
            <div class="input-field" id="opinion-box">
                <label id="mo-label">Opinion:</label>
                <textarea name="opinion" id="medical_opinion-field"></textarea>
            </div>
            <div class="input-field">
                <label>Phone:</label>
